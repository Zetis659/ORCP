...
- [ORCP — Optical Recognition of Cars and Prices](#orcp--optical-recognition-of-cars-and-prices)
  ...
  - [1. Data Collection](#1-data-collection)
      - [Структура парсинга:](#структура-парсинга)
  ...
  - [3. Telegram Bot](#3-telegram-bot)
    ...
    - [3.1 Логика работы бота:](#31-логика-работы-бота)
    - [З.2 Launching the bot](#з2-launching-the-bot)
  - [License](#license)
## Project Overview
